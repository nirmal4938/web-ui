...
import { MatrixMatchQuestionCard } from "@/components/organisms/Questions/MatrixMatchQuestionCard";
...
export default function MatrixMatchLayout() {
  return (
    <Page>
      <ControlBar>
        <div style={{ display: "flex", gap: 12 }}>
          <Typography variant="label" muted>Question Type</Typography>
          <Badge>Matrix Match</Badge>
        </div>
